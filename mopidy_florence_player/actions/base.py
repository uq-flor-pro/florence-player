'''
Python module for Florence Player base action.
'''
...
class Action:
    ...
    def __init__(self, uid, alias=None, parameter=None, is_rfid=True):
        '''
        Constructor.
        '''
        self.uid       = uid
        ...
        self.scanned   = None
        # either is rfid or else station
